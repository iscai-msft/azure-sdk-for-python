...
class _NestedDiscriminatorClientOperationsMixin(
    ...
    async def get_model(self, **kwargs: Any) -> _models.Fish:
        ...
        :rtype: ~type.model.inheritance.nesteddiscriminator.models.Fish
    ...
    async def put_model(self, input: _models.Fish, *, content_type: str = "application/json", **kwargs: Any) -> None:
        ...
        :type input: ~type.model.inheritance.nesteddiscriminator.models.Fish
    ...
    async def put_model(self, input: Union[_models.Fish, JSON, IO[bytes]], **kwargs: Any) -> None:
        ...
        :type input: ~type.model.inheritance.nesteddiscriminator.models.Fish or JSON or IO[bytes]
        :return: None
        :rtype: None
        :raises ~corehttp.exceptions.HttpResponseError:
        """
