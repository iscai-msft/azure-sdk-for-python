...
class Eagle(Bird, discriminator="eagle"):
    ...
    :vartype kind: str
    :ivar friends:
    :vartype friends: list[~type.model.inheritance.singlediscriminator.models.Bird]
    :ivar hate:
    :vartype hate: dict[str, ~type.model.inheritance.singlediscriminator.models.Bird]
    :ivar partner:
    :vartype partner: ~type.model.inheritance.singlediscriminator.models.Bird
    """
