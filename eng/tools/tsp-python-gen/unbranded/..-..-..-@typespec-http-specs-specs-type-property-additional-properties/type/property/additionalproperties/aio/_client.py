...
class AdditionalPropertiesClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype extends_unknown_derived:
     type.property.additionalproperties.aio.operations.ExtendsUnknownDerivedOperations
    :ivar extends_unknown_discriminated: ExtendsUnknownDiscriminatedOperations operations
    :vartype extends_unknown_discriminated:
     type.property.additionalproperties.aio.operations.ExtendsUnknownDiscriminatedOperations
    ...
    :vartype is_unknown_derived:
     type.property.additionalproperties.aio.operations.IsUnknownDerivedOperations
    :ivar is_unknown_discriminated: IsUnknownDiscriminatedOperations operations
    :vartype is_unknown_discriminated:
     type.property.additionalproperties.aio.operations.IsUnknownDiscriminatedOperations
    ...
    :vartype spread_string:
     type.property.additionalproperties.aio.operations.SpreadStringOperations
    ...
    :vartype spread_float: type.property.additionalproperties.aio.operations.SpreadFloatOperations
    ...
    :vartype spread_model: type.property.additionalproperties.aio.operations.SpreadModelOperations
    ...
    :vartype extends_different_spread_string:
     type.property.additionalproperties.aio.operations.ExtendsDifferentSpreadStringOperations
    ...
    :vartype extends_different_spread_float:
     type.property.additionalproperties.aio.operations.ExtendsDifferentSpreadFloatOperations
    ...
    :vartype extends_different_spread_model:
     type.property.additionalproperties.aio.operations.ExtendsDifferentSpreadModelOperations
    ...
    :vartype extends_different_spread_model_array:
     type.property.additionalproperties.aio.operations.ExtendsDifferentSpreadModelArrayOperations
    :ivar multiple_spread: MultipleSpreadOperations operations
    :vartype multiple_spread:
     type.property.additionalproperties.aio.operations.MultipleSpreadOperations
    :ivar spread_record_union: SpreadRecordUnionOperations operations
    :vartype spread_record_union:
     type.property.additionalproperties.aio.operations.SpreadRecordUnionOperations
    ...
    :vartype spread_record_non_discriminated_union:
     type.property.additionalproperties.aio.operations.SpreadRecordNonDiscriminatedUnionOperations
    ...
    :vartype spread_record_non_discriminated_union2:
     type.property.additionalproperties.aio.operations.SpreadRecordNonDiscriminatedUnion2Operations
    ...
    :vartype spread_record_non_discriminated_union3:
     type.property.additionalproperties.aio.operations.SpreadRecordNonDiscriminatedUnion3Operations
