...
class ArrayClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype int32_value: type.array.operations.Int32ValueOperations
    :ivar int64_value: Int64ValueOperations operations
    :vartype int64_value: type.array.operations.Int64ValueOperations
    :ivar boolean_value: BooleanValueOperations operations
    :vartype boolean_value: type.array.operations.BooleanValueOperations
    :ivar string_value: StringValueOperations operations
    :vartype string_value: type.array.operations.StringValueOperations
    :ivar float32_value: Float32ValueOperations operations
    :vartype float32_value: type.array.operations.Float32ValueOperations
    :ivar datetime_value: DatetimeValueOperations operations
    :vartype datetime_value: type.array.operations.DatetimeValueOperations
    :ivar duration_value: DurationValueOperations operations
    :vartype duration_value: type.array.operations.DurationValueOperations
    :ivar unknown_value: UnknownValueOperations operations
    :vartype unknown_value: type.array.operations.UnknownValueOperations
    :ivar model_value: ModelValueOperations operations
    :vartype model_value: type.array.operations.ModelValueOperations
    :ivar nullable_float_value: NullableFloatValueOperations operations
    :vartype nullable_float_value: type.array.operations.NullableFloatValueOperations
    :ivar nullable_int32_value: NullableInt32ValueOperations operations
    :vartype nullable_int32_value: type.array.operations.NullableInt32ValueOperations
    :ivar nullable_boolean_value: NullableBooleanValueOperations operations
    :vartype nullable_boolean_value: type.array.operations.NullableBooleanValueOperations
    :ivar nullable_string_value: NullableStringValueOperations operations
    :vartype nullable_string_value: type.array.operations.NullableStringValueOperations
    :ivar nullable_model_value: NullableModelValueOperations operations
    :vartype nullable_model_value: type.array.operations.NullableModelValueOperations
