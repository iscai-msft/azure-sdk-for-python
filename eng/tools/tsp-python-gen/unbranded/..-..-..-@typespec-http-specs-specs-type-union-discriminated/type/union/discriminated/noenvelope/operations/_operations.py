...
class NoEnvelopeOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~type.union.discriminated.DiscriminatedClient`'s
...
class NoEnvelopeDefaultOperations:
    ...
    def get(self, *, kind: Optional[str] = None, **kwargs: Any) -> "_types.PetInline":
        ...
        :paramtype kind: str
        :return: Cat or Dog
        :rtype: ~type.union.discriminated.models.Cat or ~type.union.discriminated.models.Dog
    ...
    @overload
    def put(self, input: _models2.Cat, *, content_type: str = "application/json", **kwargs: Any) -> "_types.PetInline":
        """put.

        :param input: Required.
        :type input: ~type.union.discriminated.models.Cat
    ...
    @overload
    def put(self, input: _models2.Dog, *, content_type: str = "application/json", **kwargs: Any) -> "_types.PetInline":
        """put.

        :param input: Required.
        :type input: ~type.union.discriminated.models.Dog
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: Cat or Dog
    ...
    def put(self, input: "_types.PetInline", **kwargs: Any) -> "_types.PetInline":
        ...
        :type input: ~type.union.discriminated.models.Cat or ~type.union.discriminated.models.Dog
        :return: Cat or Dog
        :rtype: ~type.union.discriminated.models.Cat or ~type.union.discriminated.models.Dog
        :raises ~corehttp.exceptions.HttpResponseError:
        """
...
class NoEnvelopeCustomDiscriminatorOperations:
    ...
    @overload
    def put(
        self, input: _models2.Cat, *, content_type: str = "application/json", **kwargs: Any
    ...
    @overload
    def put(
        self, input: _models2.Dog, *, content_type: str = "application/json", **kwargs: Any
    ) -> "_types.PetInlineWithCustomDiscriminator":
        """put.
