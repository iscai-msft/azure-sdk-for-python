...
from .envelope.operations import EnvelopeOperations
from .noenvelope.operations import NoEnvelopeOperations
...
class DiscriminatedClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype envelope: type.union.discriminated.operations.EnvelopeOperations
    :ivar no_envelope: NoEnvelopeOperations operations
    :vartype no_envelope: type.union.discriminated.operations.NoEnvelopeOperations
