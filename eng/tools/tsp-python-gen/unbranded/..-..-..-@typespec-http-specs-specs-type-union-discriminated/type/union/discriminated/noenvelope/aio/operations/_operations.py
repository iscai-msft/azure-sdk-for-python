...
from ....aio._configuration import DiscriminatedClientConfiguration
...
class NoEnvelopeOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~type.union.discriminated.aio.DiscriminatedClient`'s
...
class NoEnvelopeDefaultOperations:
    ...
    @overload
    async def put(
        self, input: _models3.Cat, *, content_type: str = "application/json", **kwargs: Any
    ) -> "_types.PetInline":
        """put.
    ...
    @overload
    async def put(
        self, input: _models3.Dog, *, content_type: str = "application/json", **kwargs: Any
    ) -> "_types.PetInline":
        """put.
