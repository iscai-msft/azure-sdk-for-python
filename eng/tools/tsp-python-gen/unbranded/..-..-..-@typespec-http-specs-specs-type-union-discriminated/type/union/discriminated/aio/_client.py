...
from ..envelope.aio.operations import EnvelopeOperations
from ..noenvelope.aio.operations import NoEnvelopeOperations
...
class DiscriminatedClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype envelope: type.union.discriminated.aio.operations.EnvelopeOperations
    :ivar no_envelope: NoEnvelopeOperations operations
    :vartype no_envelope: type.union.discriminated.aio.operations.NoEnvelopeOperations
