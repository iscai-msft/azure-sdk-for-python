...
class CollectionsModelProperty(_Model):
    ...
    :ivar property: Property. Required.
    :vartype property: list[~type.property.valuetypes.models.InnerModel]
    """
...
class EnumProperty(_Model):
    ...
    :vartype property: str or ~type.property.valuetypes.models.FixedInnerEnum
    """
...
class ExtensibleEnumProperty(_Model):
    ...
    :ivar property: Property. Required. Known values are: "ValueOne" and "ValueTwo".
    :vartype property: str or ~type.property.valuetypes.models.InnerEnum
    """
...
class ModelProperty(_Model):
    ...
    :ivar property: Property. Required.
    :vartype property: ~type.property.valuetypes.models.InnerModel
    """
...
class UnionEnumValueProperty(_Model):
    ...
    :vartype property: str or ~type.property.valuetypes.models.ENUM_VALUE2
    """
