...
class ScalarClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype string: type.scalar.aio.operations.StringOperations
    :ivar boolean: BooleanOperations operations
    :vartype boolean: type.scalar.aio.operations.BooleanOperations
    :ivar unknown: UnknownOperations operations
    :vartype unknown: type.scalar.aio.operations.UnknownOperations
    :ivar decimal_type: DecimalTypeOperations operations
    :vartype decimal_type: type.scalar.aio.operations.DecimalTypeOperations
    :ivar decimal128_type: Decimal128TypeOperations operations
    :vartype decimal128_type: type.scalar.aio.operations.Decimal128TypeOperations
    :ivar decimal_verify: DecimalVerifyOperations operations
    :vartype decimal_verify: type.scalar.aio.operations.DecimalVerifyOperations
    :ivar decimal128_verify: Decimal128VerifyOperations operations
    :vartype decimal128_verify: type.scalar.aio.operations.Decimal128VerifyOperations
