...
class ScalarClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype string: type.scalar.operations.StringOperations
    :ivar boolean: BooleanOperations operations
    :vartype boolean: type.scalar.operations.BooleanOperations
    :ivar unknown: UnknownOperations operations
    :vartype unknown: type.scalar.operations.UnknownOperations
    :ivar decimal_type: DecimalTypeOperations operations
    :vartype decimal_type: type.scalar.operations.DecimalTypeOperations
    :ivar decimal128_type: Decimal128TypeOperations operations
    :vartype decimal128_type: type.scalar.operations.Decimal128TypeOperations
    :ivar decimal_verify: DecimalVerifyOperations operations
    :vartype decimal_verify: type.scalar.operations.DecimalVerifyOperations
    :ivar decimal128_verify: Decimal128VerifyOperations operations
    :vartype decimal128_verify: type.scalar.operations.Decimal128VerifyOperations
