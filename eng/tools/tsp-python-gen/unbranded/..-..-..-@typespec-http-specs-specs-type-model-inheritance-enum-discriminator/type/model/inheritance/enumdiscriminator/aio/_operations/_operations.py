...
class _EnumDiscriminatorClientOperationsMixin(
    ...
    async def get_extensible_model(self, **kwargs: Any) -> _models.Dog:
        ...
        :rtype: ~type.model.inheritance.enumdiscriminator.models.Dog
    ...
    async def put_extensible_model(
        ...
        :type input: ~type.model.inheritance.enumdiscriminator.models.Dog
    ...
    async def put_extensible_model(self, input: Union[_models.Dog, JSON, IO[bytes]], **kwargs: Any) -> None:
        ...
        :type input: ~type.model.inheritance.enumdiscriminator.models.Dog or JSON or IO[bytes]
        :return: None
        :rtype: None
        :raises ~corehttp.exceptions.HttpResponseError:
        """
    ...
    async def get_fixed_model(self, **kwargs: Any) -> _models.Snake:
        ...
        :rtype: ~type.model.inheritance.enumdiscriminator.models.Snake
        :raises ~corehttp.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def put_fixed_model(
        ...
        :type input: ~type.model.inheritance.enumdiscriminator.models.Snake
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: None
    ...
    async def put_fixed_model(self, input: Union[_models.Snake, JSON, IO[bytes]], **kwargs: Any) -> None:
        ...
        :type input: ~type.model.inheritance.enumdiscriminator.models.Snake or JSON or IO[bytes]
        :return: None
        :rtype: None
        :raises ~corehttp.exceptions.HttpResponseError:
        """
