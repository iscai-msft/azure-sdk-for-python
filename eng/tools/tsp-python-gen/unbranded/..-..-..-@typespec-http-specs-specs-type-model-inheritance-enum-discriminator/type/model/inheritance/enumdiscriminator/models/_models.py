...
class Snake(_Model):
    ...
    :vartype kind: str or ~type.model.inheritance.enumdiscriminator.models.SnakeKind
...
class Cobra(Snake, discriminator="cobra"):
    ...
    :vartype kind: str or ~type.model.inheritance.enumdiscriminator.models.COBRA
    """
...
class Dog(_Model):
    ...
    :vartype kind: str or ~type.model.inheritance.enumdiscriminator.models.DogKind
...
class Golden(Dog, discriminator="golden"):
    ...
    :vartype kind: str or ~type.model.inheritance.enumdiscriminator.models.GOLDEN
    """
