...
class OptionalClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype plain_date: type.property.optional.operations.PlainDateOperations
    :ivar plain_time: PlainTimeOperations operations
    :vartype plain_time: type.property.optional.operations.PlainTimeOperations
    ...
    :vartype string_literal: type.property.optional.operations.StringLiteralOperations
    :ivar int_literal: IntLiteralOperations operations
    :vartype int_literal: type.property.optional.operations.IntLiteralOperations
    :ivar float_literal: FloatLiteralOperations operations
    :vartype float_literal: type.property.optional.operations.FloatLiteralOperations
    :ivar boolean_literal: BooleanLiteralOperations operations
    :vartype boolean_literal: type.property.optional.operations.BooleanLiteralOperations
    :ivar union_string_literal: UnionStringLiteralOperations operations
    :vartype union_string_literal: type.property.optional.operations.UnionStringLiteralOperations
    :ivar union_int_literal: UnionIntLiteralOperations operations
    :vartype union_int_literal: type.property.optional.operations.UnionIntLiteralOperations
    :ivar union_float_literal: UnionFloatLiteralOperations operations
    :vartype union_float_literal: type.property.optional.operations.UnionFloatLiteralOperations
