# Type Model Inheritance Nesteddiscriminator client library for Python
...
```bash
python -m pip install type-model-inheritance-nesteddiscriminator
```
...
- An existing Type Model Inheritance Nesteddiscriminator instance.
