# Type Model Inheritance Singlediscriminator client library for Python
...
```bash
python -m pip install type-model-inheritance-singlediscriminator
```
...
- An existing Type Model Inheritance Singlediscriminator instance.
