# Type Model Inheritance Enumdiscriminator client library for Python
...
```bash
python -m pip install type-model-inheritance-enumdiscriminator
```
...
- An existing Type Model Inheritance Enumdiscriminator instance.
