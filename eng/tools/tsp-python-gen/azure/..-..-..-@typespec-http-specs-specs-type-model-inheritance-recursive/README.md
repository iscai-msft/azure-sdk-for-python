# Type Model Inheritance Recursive client library for Python
...
```bash
python -m pip install type-model-inheritance-recursive
```
...
- An existing Type Model Inheritance Recursive instance.
