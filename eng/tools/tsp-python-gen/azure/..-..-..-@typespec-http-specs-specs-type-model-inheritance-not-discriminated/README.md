# Type Model Inheritance Notdiscriminated client library for Python
...
```bash
python -m pip install type-model-inheritance-notdiscriminated
```
...
- An existing Type Model Inheritance Notdiscriminated instance.
