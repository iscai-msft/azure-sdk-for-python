...
class AppendBlobOperations:
    ...
    async def append_block(
        ...
        lease_access_conditions: Optional["models.LeaseAccessConditions"] = None,
        append_position_access_conditions: Optional["models.AppendPositionAccessConditions"] = None,
        cpk_info: Optional["models.CpkInfo"] = None,
        cpk_scope_info: Optional["models.CpkScopeInfo"] = None,
        modified_access_conditions: Optional["models.ModifiedAccessConditions"] = None,
        **kwargs
        ...
        if request_id is not None:
            header_parameters['x-ms-client-request-id'] = self._serialize.header("request_id", request_id, 'str')
        header_parameters['Content-Type'] = kwargs.pop('content_type', 'application/octet-stream')
