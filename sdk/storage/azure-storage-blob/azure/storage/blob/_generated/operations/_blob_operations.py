...
class BlobOperations(object):
    ...
    def delete(
        ...
        snapshot=None,  # type: Optional[str]
        timeout=None,  # type: Optional[int]
        delete_snapshots=None,  # type: Optional[Union[str, "models.DeleteSnapshotsOptionType"]]
        request_id=None,  # type: Optional[str]
        lease_access_conditions=None,  # type: Optional["models.LeaseAccessConditions"]
        modified_access_conditions=None,  # type: Optional["models.ModifiedAccessConditions"]
        **kwargs  # type: Any
    ...
    def start_copy_from_url(
        ...
        rehydrate_priority=None,  # type: Optional[Union[str, "models.RehydratePriority"]]
        request_id=None,  # type: Optional[str]
        source_modified_access_conditions=None,  # type: Optional["models.SourceModifiedAccessConditions"]
        modified_access_conditions=None,  # type: Optional["models.ModifiedAccessConditions"]
        lease_access_conditions=None,  # type: Optional["models.LeaseAccessConditions"]
    ...
    def set_tier(
        self,
        tier,  # type: Union[str, "models.AccessTierRequired"]
        timeout=None,  # type: Optional[int]
        rehydrate_priority=None,  # type: Optional[Union[str, "models.RehydratePriority"]]
        request_id=None,  # type: Optional[str]
        lease_access_conditions=None,  # type: Optional["models.LeaseAccessConditions"]
