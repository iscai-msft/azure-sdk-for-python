...
class BitLockerKeysOperations:
    ...
    def list(
     ...
     within the user subscription.
        ...
        :return: An iterator like instance of GetBitLockerKeysResponse or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.storageimportexport.models.GetBitLockerKeysResponse]
