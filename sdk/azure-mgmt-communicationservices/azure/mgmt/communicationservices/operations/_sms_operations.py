...
class SmsOperations(object):
    ...
    :type models: ~azure.mgmt.communicationservices.models
    ...
    def send(
        ...
        **kwargs  # type: Any
        ...
        :type send_message_request: ~azure.mgmt.communicationservices.models.SendMessageRequest
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: SendSmsResponse, or the result of cls(response)
        :rtype: ~azure.mgmt.communicationservices.models.SendSmsResponse
