...
class AddThreadMembersRequest(msrest.serialization.Model):
    ...
    :type members: list[~azure_communication_services.models.ThreadMember]
    """
...
class CreateMessageRequest(msrest.serialization.Model):
    ...
    :type priority: str or ~azure_communication_services.models.MessagePriority
...
class ListMessagesResponse(msrest.serialization.Model):
    ...
    :vartype messages: list[~azure_communication_services.models.Message]
...
class ListThreadsResponse(msrest.serialization.Model):
    ...
    :vartype threads: list[~azure_communication_services.models.ThreadInfo]
...
class MultiStatusResponse(msrest.serialization.Model):
    ...
    :vartype multiple_status: list[~azure_communication_services.models.IndividualStatusResponse]
    """
...
class SendMessageRequest(msrest.serialization.Model):
    ...
    :type send_sms_options: ~azure_communication_services.models.SendSmsOptions
    """
