...
class SmsOperations(object):
    ...
    :type models: ~azure_communication_services.models
    ...
    def send(
        ...
        **kwargs  # type: Any
        ...
        :type send_message_request: ~azure_communication_services.models.SendMessageRequest
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: SendSmsResponse, or the result of cls(response)
        :rtype: ~azure_communication_services.models.SendSmsResponse
