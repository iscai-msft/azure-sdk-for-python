...
class KeyVaultClientOperationsMixin(object):
    ...
    async def create_key(
        ...
        **kwargs
        ...
        mixin_instance._serialize = Serializer(self._models_dict(api_version))
        mixin_instance._deserialize = Deserializer(self._models_dict(api_version))
        return await mixin_instance.create_key(vault_base_url, key_name, kty, key_size, public_exponent, key_ops, key_attributes, tags, curve, release_policy, **kwargs)
    ...
    async def decrypt(
        ...
        **kwargs
        ...
        mixin_instance._serialize = Serializer(self._models_dict(api_version))
        mixin_instance._deserialize = Deserializer(self._models_dict(api_version))
        return await mixin_instance.decrypt(vault_base_url, key_name, key_version, algorithm, value, iv, aad, tag, **kwargs)
    ...
    async def encrypt(
        ...
        **kwargs
        ...
        mixin_instance._serialize = Serializer(self._models_dict(api_version))
        mixin_instance._deserialize = Deserializer(self._models_dict(api_version))
        return await mixin_instance.encrypt(vault_base_url, key_name, key_version, algorithm, value, iv, aad, tag, **kwargs)
    ...
    async def export_key(
        ...
        **kwargs
        ...
        mixin_instance._serialize = Serializer(self._models_dict(api_version))
        mixin_instance._deserialize = Deserializer(self._models_dict(api_version))
        return await mixin_instance.export_key(vault_base_url, key_name, key_version, environment, **kwargs)
    ...
    async def import_key(
        ...
        **kwargs
        ...
        mixin_instance._serialize = Serializer(self._models_dict(api_version))
        mixin_instance._deserialize = Deserializer(self._models_dict(api_version))
        return await mixin_instance.import_key(vault_base_url, key_name, key, hsm, key_attributes, tags, release_policy, **kwargs)
    ...
    async def unwrap_key(
        ...
        **kwargs
        ...
        mixin_instance._serialize = Serializer(self._models_dict(api_version))
        mixin_instance._deserialize = Deserializer(self._models_dict(api_version))
        return await mixin_instance.unwrap_key(vault_base_url, key_name, key_version, algorithm, value, iv, aad, tag, **kwargs)
    ...
    async def update_key(
        ...
        **kwargs
        ...
        mixin_instance._serialize = Serializer(self._models_dict(api_version))
        mixin_instance._deserialize = Deserializer(self._models_dict(api_version))
        return await mixin_instance.update_key(vault_base_url, key_name, key_version, key_ops, key_attributes, tags, release_policy, **kwargs)
    ...
    async def wrap_key(
        ...
        **kwargs
        ...
        mixin_instance._serialize = Serializer(self._models_dict(api_version))
        mixin_instance._deserialize = Deserializer(self._models_dict(api_version))
        return await mixin_instance.wrap_key(vault_base_url, key_name, key_version, algorithm, value, iv, aad, tag, **kwargs)
