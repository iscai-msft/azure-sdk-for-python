...
class KeyVaultClientOperationsMixin(object):
    ...
    def create_key(
        ...
        public_exponent=None,  # type: Optional[int]
        ...
        release_policy=None,  # type: Optional["models.KeyReleasePolicy"]
        **kwargs  # type: Any
    ):
    ...
    def decrypt(
        ...
        value,  # type: bytes
        iv=None,  # type: Optional[bytes]
        aad=None,  # type: Optional[bytes]
        tag=None,  # type: Optional[bytes]
        **kwargs  # type: Any
    ):
        ...
        mixin_instance._serialize = Serializer(self._models_dict(api_version))
        mixin_instance._deserialize = Deserializer(self._models_dict(api_version))
        return mixin_instance.decrypt(vault_base_url, key_name, key_version, algorithm, value, iv, aad, tag, **kwargs)
    ...
    def encrypt(
        ...
        **kwargs  # type: Any
        ...
        mixin_instance._serialize = Serializer(self._models_dict(api_version))
        mixin_instance._deserialize = Deserializer(self._models_dict(api_version))
        return mixin_instance.encrypt(vault_base_url, key_name, key_version, algorithm, value, iv, aad, tag, **kwargs)
    ...
    def export_key(
        ...
        **kwargs  # type: Any
        ...
        mixin_instance._serialize = Serializer(self._models_dict(api_version))
        mixin_instance._deserialize = Deserializer(self._models_dict(api_version))
        return mixin_instance.export_key(vault_base_url, key_name, key_version, environment, **kwargs)
    ...
    def import_key(
        ...
        **kwargs  # type: Any
        ...
        mixin_instance._serialize = Serializer(self._models_dict(api_version))
        mixin_instance._deserialize = Deserializer(self._models_dict(api_version))
        return mixin_instance.import_key(vault_base_url, key_name, key, hsm, key_attributes, tags, release_policy, **kwargs)
    ...
    def unwrap_key(
        ...
        **kwargs  # type: Any
        ...
        mixin_instance._serialize = Serializer(self._models_dict(api_version))
        mixin_instance._deserialize = Deserializer(self._models_dict(api_version))
        return mixin_instance.unwrap_key(vault_base_url, key_name, key_version, algorithm, value, iv, aad, tag, **kwargs)
    ...
    def update_key(
        ...
        **kwargs  # type: Any
        ...
        mixin_instance._serialize = Serializer(self._models_dict(api_version))
        mixin_instance._deserialize = Deserializer(self._models_dict(api_version))
        return mixin_instance.update_key(vault_base_url, key_name, key_version, key_ops, key_attributes, tags, release_policy, **kwargs)
    ...
    def wrap_key(
        ...
        **kwargs  # type: Any
        ...
        mixin_instance._serialize = Serializer(self._models_dict(api_version))
        mixin_instance._deserialize = Deserializer(self._models_dict(api_version))
        return mixin_instance.wrap_key(vault_base_url, key_name, key_version, algorithm, value, iv, aad, tag, **kwargs)
